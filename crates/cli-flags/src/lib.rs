...
use wasmtime::{Config, Engine, OmitBoundsChecks, Result, WasmBacktraceDetails, WasmFeatures, bail};
...
wasmtime_option_group! {
    pub struct ExperimentalOptions {
        ...
        pub unsafe_omit_bounds_checks: Option<wasmtime::OmitBoundsChecks>,
    }
...
impl CommonOptions {
    ...
    pub fn enable_wasm_features(&self, config: &mut Config) -> Result<()> {
        ...
        config.unsafe_omit_bounds_checks(self.experimental.unsafe_omit_bounds_checks.unwrap_or(OmitBoundsChecks::None));
    ...
    pub fn from_engine(engine: &Engine) -> Self {
        ...
        CommonOptions {
            ...
            experimental_raw: Default::default(),
