...
impl WasiP1Ctx {
    ...
    fn consume_fuel_for_array<T>(&mut self, array: wiggle::GuestPtr<[T], u32>) -> Result<()> {
    ...
    fn read_string(&mut self, memory: &GuestMemory<'_>, ptr: GuestPtr<str, u32>) -> Result<String> {
...
fn write_bytes(
    ...
    ptr: GuestPtr<u8, u32>,
    buf: &[u8],
) -> Result<GuestPtr<u8, u32>, types::Error> {
